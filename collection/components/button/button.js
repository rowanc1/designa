  ...
  constructor() {
    ...
    this.generateButton = () => {
      ...
      return (h(TagType, Object.assign({ class: {
        ...
        this.icon === undefined ? null : typeof this.icon === 'string' ? (h("stencila-icon", { icon: this.isLoading ? 'loader-2' : this.icon, class: { spin: this.isLoading } })) : (this.icon),
        h("span", { class: "label" },
          h("slot", null))));
    };
  }
