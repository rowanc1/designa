...
import { N as Nt } from './schema-ceac4a12.js';
...
const parseCreativeWorks = (c, path = '/') => (h("ul", { class: "toc-list" }, c.map((part) => {
  var _a, _b, _c;
  return part.parts !== undefined ? (h("li", null, h("details", { open: true }, h("summary", null, part.name), parseCreativeWorks(part.parts, ((_a = part.name) !== null && _a !== void 0 ? _a : '') + '/')))) : (h("li", null, h("a", { class: "toc-link", href: path + ((_b = part.name) !== null && _b !== void 0 ? _b : '') }, part.name, " (", h("code", null, path + ((_c = part.name) !== null && _c !== void 0 ? _c : '')), ")")));
})));
const VerticalNav = class {
  ...
  componentWillLoad() {
    ...
    const _col = Array.from(document.querySelectorAll('script[type="application/ld+json"]')).reduce((scripts, el) => {
      ...
      return Nt('Collection', contents) ? [...scripts, contents] : scripts;
    }, []);
...
export { VerticalNav as stencila_vertical_nav };
