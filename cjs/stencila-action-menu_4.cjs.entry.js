...
const ActionMenu = class {
  ...
  render() {
    return (index.h("nav", null, index.h("span", { class: {
      ...
      }, style: { '--max-width': this.width } }, index.h("slot", null)), index.h("stencila-button", { onClick: this.toggleActionMenu, icon: "more", color: "key", minimal: true, size: "xsmall", iconOnly: true, ariaLabel: "Toggle Action Menu" })), index.h("span", { class: "persistentActions" }, index.h("slot", { name: slots.persistentActions }))));
  }
...
const Error$1 = class {
  ...
  render() {
    return (index.h(index.Host, { kind: this.kind }, index.h("div", { class: "overview" }, index.h("stencila-icon", { icon: "alert" }), index.h("slot", null)), this.hasStacktrace && (index.h("stencila-details", null, index.h("span", { slot: "summary" }, "View the stacktrace"), index.h("slot", { name: "stacktrace" })))));
  }
};
Error$1.style = {
...
const Editor = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: cssClasses.container }, index.h("div", { class: cssClasses.editor, onKeyDown: this.stopEventPropagation, onClick: this.focusEditor }, index.h("div", { class: "hidden" }, index.h("slot", { name: slots$1.text })), index.h("div", { id: cssIds.editorTarget })), index.h("menu", null, index.h("label", { "aria-label": "Programming Language" }, index.h("stencila-icon", { icon: "terminal" }), index.h("select", { onChange: this.setLanguage }, this.languageCapabilities.map((language) => (index.h("option", { value: language.toLowerCase(), selected: language.toLowerCase() === this.activeLanguage }, language)))))))));
  }
  get el() { return index.getElement(this); }
...
var Option$1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.apFirst = function (fb) {
    return _function._function.flow(exports.map(function (a) { return function () { return a; }; }), exports.ap(fb));
};
/**
...
exports.apSecond = function (fb) {
    return _function._function.flow(exports.map(function () { return function (b) { return b; }; }), exports.ap(fb));
};
/**
...
exports.chainFirst = function (f) {
    return exports.chain(function (a) {
        return _function._function.pipe(f(a), exports.map(function () { return a; }));
    });
};
/**
 * @category Monad
...
exports.flatten = 
/*#__PURE__*/
exports.chain(_function._function.identity);
/**
...
exports.duplicate = 
/*#__PURE__*/
exports.extend(_function._function.identity);
/**
 * @category Foldable
 * @since 2.0.0
 */
 ...
 * @since 2.8.0
 */
exports.bindTo = function (name) { return exports.map(_function._function.bindTo_(name)); };
/**
 * @since 2.8.0
 */
exports.bind = function (name, f) {
    return exports.chain(function (a) {
        return _function._function.pipe(f(a), exports.map(function (b) { return _function._function.bind_(a, name, b); }));
    });
};
// -------------------------------------------------------------------------------------
// pipeable sequence S
...
exports.apS = function (name, fb) {
    return _function._function.flow(exports.map(function (a) { return function (b) { return _function._function.bind_(a, name, b); }; }), exports.ap(fb));
};
});

var Ordering = _commonjsHelpers.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var Ord = _commonjsHelpers.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var contramap_ = function (fa, f) { return _function._function.pipe(fa, exports.contramap(f)); };
// -------------------------------------------------------------------------------------
// pipeables
// -------------------------------------------------------------------------------------
/**
...
exports.ordDate = 
/*#__PURE__*/
_function._function.pipe(exports.ordNumber, exports.contramap(function (date) { return date.valueOf(); }));
/**
 * @category instances
 * @since 2.7.0
 */
...
var ReadonlyArray = _commonjsHelpers.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
// non-pipeables
// -------------------------------------------------------------------------------------
var map_ = function (fa, f) { return _function._function.pipe(fa, exports.map(f)); };
var mapWithIndex_ = function (fa, f) { return _function._function.pipe(fa, exports.mapWithIndex(f)); };
var ap_ = function (fab, fa) { return _function._function.pipe(fab, exports.ap(fa)); };
var chain_ = function (ma, f) {
    return _function._function.pipe(ma, exports.chain(f));
};
var filter_ = function (fa, predicate) { return _function._function.pipe(fa, exports.filter(predicate)); };
var filterMap_ = function (fa, f) { return _function._function.pipe(fa, exports.filterMap(f)); };
var partitionWithIndex_ = function (fa, predicateWithIndex) { return _function._function.pipe(fa, exports.partitionWithIndex(predicateWithIndex)); };
var partition_ = function (fa, predicate) { return _function._function.pipe(fa, exports.partition(predicate)); };
var partitionMap_ = function (fa, f) { return _function._function.pipe(fa, exports.partitionMap(f)); };
var partitionMapWithIndex_ = function (fa, f) { return _function._function.pipe(fa, exports.partitionMapWithIndex(f)); };
var alt_ = function (fa, that) { return _function._function.pipe(fa, exports.alt(that)); };
var reduce_ = function (fa, b, f) { return _function._function.pipe(fa, exports.reduce(b, f)); };
var foldMap_ = function (M) {
    var foldMapM = exports.foldMap(M);
    return function (fa, f) { return _function._function.pipe(fa, foldMapM(f)); };
};
var reduceRight_ = function (fa, b, f) { return _function._function.pipe(fa, exports.reduceRight(b, f)); };
...
var reduceRightWithIndex_ = function (fa, b, f) {
    return _function._function.pipe(fa, exports.reduceRightWithIndex(b, f));
};
var filterMapWithIndex_ = function (fa, f) {
    return _function._function.pipe(fa, exports.filterMapWithIndex(f));
};
var filterWithIndex_ = function (fa, predicateWithIndex) { return _function._function.pipe(fa, exports.filterWithIndex(predicateWithIndex)); };
var extend_ = function (fa, f) { return _function._function.pipe(fa, exports.extend(f)); };
var traverse_ = function (F) {
    var traverseF = exports.traverse(F);
    return function (ta, f) { return _function._function.pipe(ta, traverseF(f)); };
};
/* istanbul ignore next */
var traverseWithIndex_ = function (F) {
    var traverseWithIndexF = exports.traverseWithIndex(F);
    return function (ta, f) { return _function._function.pipe(ta, traverseWithIndexF(f)); };
};
/* istanbul ignore next */
var wither_ = function (F) {
    var witherF = exports.wither(F);
    return function (fa, f) { return _function._function.pipe(fa, witherF(f)); };
};
/* istanbul ignore next */
var wilt_ = function (F) {
    var wiltF = exports.wilt(F);
    return function (fa, f) { return _function._function.pipe(fa, wiltF(f)); };
};
// -------------------------------------------------------------------------------------
// pipeables
// -------------------------------------------------------------------------------------
...
exports.ap = function (fa) {
    return exports.chain(function (f) { return _function._function.pipe(fa, exports.map(f)); });
};
/**
 * Combine two effectful actions, keeping only the result of the first.
 *
...
exports.chain = function (f) { return function (ma) {
    return _function._function.pipe(ma, exports.chainWithIndex(function (_, a) { return f(a); }));
}; };
/**
 * @since 2.7.0
 */
...
exports.compact = 
/*#__PURE__*/
exports.filterMap(_function._function.identity);
/**
 * @category Filterable
 * @since 2.5.0
 */
...
exports.wither = function (F) {
    var traverseF = exports.traverse(F);
    return function (f) { return function (fa) { return F.map(_function._function.pipe(fa, traverseF(f)), exports.compact); }; };
};
/**
 * @category Witherable
 * @since 2.6.5
...
exports.wilt = function (F) {
    var traverseF = exports.traverse(F);
    return function (f) { return function (fa) { return F.map(_function._function.pipe(fa, traverseF(f)), exports.separate); }; };
};
/**
 * @category Unfoldable
 * @since 2.6.6
...
exports.bindTo = function (name) {
    return exports.map(_function._function.bindTo_(name));
};
/**
 * @since 2.8.0
 */
...
var _Array = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const OutputsList = class {
    ...
    this.renderNode = (node) => {
      if (schema.zt(node)) {
        const text = typeof node === 'string' || typeof node === 'number'
          ? node
          : JSON.stringify(node);
        return (index.h("pre", null, index.h("output", null, text)));
      }
      else if (schema.Ut(node)) {
        return (index.h("pre", null, index.h("output", null, node.text)));
      }
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { hidden: this.nodes !== undefined, slot: true } }, index.h("slot", { name: slots$2.nodes })), this.isEmpty && (index.h("em", { class: "emptyContentMessage" }, this.emptyOutputMessage)), !this.isEmpty && index.h("figure", null, this.renderNodes(this.nodes)), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
OutputsList.style = {
...
exports.stencila_code_error = Error$1;
exports.stencila_editor = Editor;
