...
const _function = require('./function-830c7d69.js');
...
const jobStatusString = (jobObject) => _function._function.pipe(jobObject, fold$2(() => 'Requesting session', () => 'Requesting session', jobErrorMessage, (job) => job.statusMessage, jobErrorMessage, (job) => job.statusMessage));
const SessionStatus = ({ session, job }, children) => (index.h("span", { class: {
  ...
  } }, _function._function.pipe(session, fold$2(() => '', () => (index.h("span", null,
  index.h("stencila-icon", { icon: "loader-2" }),
  index.h("span", null, jobStatusString(job)))), (refreshingErroredJob) => (index.h("span", null,
  index.h("stencila-icon", { icon: "loader-2" }),
  index.h("span", null, jobErrorMessage(refreshingErroredJob)))), (refreshingSession) => (index.h("span", null, isEmpty$1(children) ? ([
  index.h("stencila-icon", { icon: "loader-2" }),
  ...
  isEmpty$1(children) ? null : index.h("span", null, children)))))));
...
const StencilaExecutableDocumentToolbar = class {
  constructor(hostRef) {
    ...
    this.handleJobStatus = (job, onJobReady, onJobError) => _function._function.pipe(job, fold$2(() => {
    ...
    this.goToActiveNode = () => {
      var _a;
      _function._function.pipe(this.codeNodeSelector(), lookup$1((_a = this.activeNodeIndex) !== null && _a !== void 0 ? _a : -1), map$1((el) => {
        var _a;
